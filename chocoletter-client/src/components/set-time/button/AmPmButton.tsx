  ...
  return (
    <div className="flex flex-col my-24 ml-4">
      ...
      <Button
        ...
        className={`m-4 w-[50px] h-[50px] flex items-center justify-center text-center hover:bg-pink-300 ${selected === "AM" ? "bg-pink-300 text-white" : ""}`}
      >
        <h1>AM</h1>
      </Button>
      ...
      <Button
        ...
        className={`m-4 w-[50px] h-[50px] flex items-center justify-center text-center hover:bg-pink-300 ${selected === "PM" ? "bg-pink-300 text-white" : ""}`}
      >
        <h1>PM</h1>
      </Button>
    </div>
