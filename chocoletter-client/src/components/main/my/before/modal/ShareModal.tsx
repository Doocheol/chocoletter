				...
				{!showQRCode ? (
					<div className="flex flex-nowrap justify-center space-x-2">
						...
						<button
							...
							className="flex flex-col items-center p-4 bg-gray-100 rounded-lg shadow hover:bg-green-100 transition focus:outline-none"
							aria-label="링크 복사"
						>
						...
						<button
							...
							className="flex flex-col items-center p-4 bg-gray-100 rounded-lg shadow hover:bg-blue-100 transition focus:outline-none"
							aria-label="QR 코드 생성"
						>
