...
export const WaitingTest = ({
	...
	useEffect(() => {
		...
		const targetUTC = new Date(
			targetTime.getTime() - 9 * 3600 * 1000 + 60 * 1000
		);
			...
			<div className="w-full min-h-screen flex flex-col justify-center items-center bg-white relative overflow-hidden z-[9999]">
				...
				<div className="w-full h-[107px] px-3 top-[35px] absolute flex-col justify-start items-end gap-0.5 inline-flex">
					...
					<div className="self-stretch h-[77px] flex flex-col justify-start items-center gap-[23px]">
						<div className="self-stretch text-center text-white text-[40px] font-normal font-sans leading-snug z-20">
							{wcomment}
						</div>
						<div className="px-[15px] py-[5px] bg-chocoletterGiftBoxBg rounded-[17px] justify-center items-center gap-[9px] inline-flex z-20">
							...
							<div
								...
								} text-2xl font-normal font-sans leading-snug z-20`}
							>
								{makeMMSS}
							</div>
						</div>
				...
				<div
					className={`w-[11dvh] h-[11dvh] bottom-[10dvh] absolute ${
						isReady ? "bg-chocoletterGiftBg" : "bg-chocoletterGreen"
					} rounded-[100px] justify-center items-center gap-2.5 inline-flex z-20`}
				>
					{isReady ? (
						<div className="font-bold font-sans text-sm text-nowrap">
							상대방
							<br />
							기다리는 중
						</div>
						...
						>
							<p className="text-white text-center font-bold font-sans w-[50%] h-[50%] flex items-center justify-center text-2xl">
								Ready
							</p>
						</button>
					)}
