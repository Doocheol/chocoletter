    ...
    return (
        <div>
            <div className="flex flex-col items-center justify-center text-center text-nowrap">
                ...
                <p className="mb-4">영상통화를 위해<br/>카메라와 비디오 <span className="text-chocoletterTextYellow">권한을 허용</span>해주세요!</p>
            </div>
            <div className="w-[11dvh] h-[11dvh] bottom-[10dvh] absolute bg-chocoletterGiftBg rounded-[100px] justify-center items-center gap-2.5 inline-flex z-20">
                <button onClick={videoPermit} className="w-full h-full aspect-square flex justify-center items-center" >
                    <p className="text-white text-center font-bold font-sans w-[50%] h-[50%] flex items-center justify-center text-2xl" >확인</p>
                </button>
            </div>
        </div>
    )
