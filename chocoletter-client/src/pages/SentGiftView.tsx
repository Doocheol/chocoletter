			...
			<div className="absolute mt-24 px-8">
				<div className="relative flex items-center justify-center mb-16 shake-vertical">
					...
					<object
						data={choco}
						type="image/svg+xml"
						className="max-h-40 relative z-20"
					>
						<img src={choco} alt="초콜릿 날개" />
					</object>
				...
				<div className="flex flex-col justify-center items-center mb-8 text-center">
					<Button
						...
						className="bg-white w-[300px] h-[50px] px-1 mb-4 hover:bg-gray-200"
					>
						내 초콜릿 상자로 이동하기
					</Button>
					<div className="w-[250px] p-[5px_15px] rounded-[18px] bg-[#b29ce4] text-sm text-white">
						{remainTime}초 후, 내 초콜릿 상자로 이동합니다.
					</div>
				</div>
			</div>
		</div>
