...
const TestPage: React.FC = () => {
	...
	const routes = [
		...
		},
		{
			...
			label: "MainYourBeforeView (/main/your/before)",
		},
		...
		{
			path: "/video/waiting-room/67890",
			label: "WaitingRoomView (/video/waiting-room/67890)",
		},
		...
		{ path: "/*", label: "Wildcard Route (/*) - ErrorPage" },
		{
			...
			label: "KakaoLoginCallback (/auth/kakao/callback)",
		},
