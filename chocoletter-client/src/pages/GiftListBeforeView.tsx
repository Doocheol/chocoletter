    ...
    return (
        <div>
            <div className="flex flex-col items-center justify-center min-h-screen min-w-screen relative bg-chocoletterGiftBoxBg overflow-hidden">
                <div className="w-full h-8vh px-4 py-[17px] bg-chocoletterPurpleBold flex-col justify-center items-center gap-[15px] inline-flex fixed top-0">
                    ...
                    <div className="px-[15px] py-[5px] bg-black/40 rounded-[18px] justify-start items-center gap-1 inline-flex">
                        <div className="text-center text-white text-[13px] font-normal font-pretendard leading-[18.20px]">현재 개봉 가능한 초콜릿 : {remainOpenCount}개</div>
                    </div>
                </div>
                <GiftList filter={"all"} />
